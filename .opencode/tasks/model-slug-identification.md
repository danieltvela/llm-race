...
- [x] Step 1.1: Create `llm_race/utils/slug.py`
...
- [x] Step 2.1: Update `Model` class in `llm_race/db/models.py`
...
- [x] Step 2.2: Update `llm_race/db/schema.sql`
...
- [x] Step 3.1: Update `ModelSummary` in `llm_race/db/types.py`
...
- [x] Step 3.2: Update `BenchmarkFilters` in `llm_race/db/types.py`
  - File(s): `llm_race/db/types.py`
  - Change:
...
- [x] Step 3.3: Update `BenchmarkSummary`, `BenchmarkDetail`, `BenchmarkGroupSummary` in `llm_race/db/types.py`
  - File(s): `llm_race/db/types.py`
  - Change:
...
- [x] Step 4.1: Update `save_benchmark_run()` signature and logic in `llm_race/db/saver.py`
...
- [x] Step 5.1: Add slug arguments to `llm_race/bench/cli.py`
...
- [x] Step 5.2: Update the runner signature in `llm_race/bench/runner.py`
...
- [x] Step 6.1: Update `llm_race/config/__init__.py`
...
- [x] Step 7.1: Update `llm_race/config/presets.json`
...
- [x] Step 7.2: Update `llm_race/config/presets.py`
...
- [x] Step 8.1: Update preset merging logic in `llm_race/bench/cli.py`
  - File(s): `llm_race/bench/cli.py`
  - Change:
...
- [x] Step 9.1: Update model listing in `llm_race/web/server.py`
...
- [x] Step 9.2: Update `llm_race/web/templates/models.html`
...
- [x] Step 9.3: Update `llm_race/web/templates/model_benchmarks.html`
...
- [x] Step 9.4: Update `llm_race/web/templates/index.html`
...
- [x] Step 9.5: Update `llm_race/web/templates/compare.html`
...
- [x] Step 9.6: Update `llm_race/web/templates/run_detail.html`
...
- [x] Step 9.7: Update `llm_race/web/templates/timeseries.html`
...
- [x] Step 10.1: Update `list_models()` in `llm_race/db/queries.py`
...
- [x] Step 10.2: Update benchmark queries in `llm_race/db/queries.py`
  - File(s): `llm_race/db/queries.py`
  - Change:
...
- [x] Step 11.1: Add tests for the slug utility module
...
- [x] Step 11.2: Update `tests/test_models.py`
...
- [x] Step 11.3: Update `tests/test_db_saver.py`
...
- [x] Step 11.4: Update `tests/test_queries.py`
...
- [x] Step 11.5: Update `tests/test_presets.py`
...
- [x] Step 11.6: Update `tests/test_providers.py`
...
- [x] Step 11.7: Update `tests/test_web.py`
...
- [x] Step 12.1: Delete old database and run a full benchmark
...
- [x] Step 12.2: Run the full test suite
  - File(s): N/A
